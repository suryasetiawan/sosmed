    ...
    render() {
        return (
            <View style={{ marginBottom: 10 }}>
                <View style={{ width: screenWidth, height: 50, backgroundColor: 'white', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderBottomColor: 'grey', borderBottomWidth: 0.5 }}>
                        ...
                        >
                            {
                                (this.props.item.likes.includes(this.props.user.uid) && this.state.liked == undefined) ?
                                    <Image source={require('../../assets/images/like-red.jpg')} style={{ width: 23, height: 23, margin: 10 }} />
                                    :
                                    (this.state.liked == true) ?
                                        <Image source={require('../../assets/images/like-red.jpg')} style={{ width: 23, height: 23, margin: 10 }} />
                                        :
                                        <Image source={require('../../assets/images/like.jpg')} style={{ width: 23, height: 23, margin: 10 }} />

                            }

                        </TouchableOpacity>
                        <Image source={require('../../assets/images/comment.jpg')} style={{ width: 23, height: 23, margin: 10 }} />
                        <Image source={require('../../assets/images/share.jpg')} style={{ width: 23, height: 23, margin: 10 }} />
                    </View>
                    <TouchableOpacity
                        onPress={() => this.savePost()}>
                        {
                            (this.props.item.savedBy.includes(this.props.user.uid) && this.state.saved == undefined) ?
                                <Image source={require('../../assets/images/save-black.jpg')} style={{ width: 23, height: 23, margin: 10 }} />
                                :
                                (this.state.saved == true) ?
                                    <Image source={require('../../assets/images/save-black.jpg')} style={{ width: 23, height: 23, margin: 10 }} />
                                    :
                                    <Image source={require('../../assets/images/save.jpg')} style={{ width: 23, height: 23, margin: 10 }} />
                        }
                    </TouchableOpacity>
                </View>
                <Text style={{ fontWeight: 'bold', marginHorizontal: 10 }}>{
                    this.props.item.likes.length + this.state.numLike} likes</Text>
