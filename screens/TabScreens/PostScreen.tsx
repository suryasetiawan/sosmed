...
import { Text, View, TouchableOpacity, Dimensions, Image, SafeAreaView } from 'react-native';
        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <Image
                    ...
                    style={{ justifyContent: 'center', alignItems: 'center', position: 'absolute', zIndex: -1, width: screenWidth, height: screenHeight }}
                />
                <View style={(Platform.OS == 'ios') ? { width: screenWidth, height: 55 } : { width: screenWidth, height: 55, marginTop: 30, justifyContent: 'space-between', alignItems: "center", flexDirection: 'row', }}>
                    <Text style={{ margin: 10, fontWeight: 'bold', fontSize: 22 }}>New post</Text>
                    <TouchableOpacity style={{ margin: 10 }}
                    onPress={()=> this.uploadPost()}
                    >
                        <Text style={{ margin: 10, fontWeight: 'bold', fontSize: 18, color: '#29a8e9' }}>Upload</Text>
                    </TouchableOpacity>
                </View>
                <View style={{ width: screenWidth, height: 360 }}>
                    {
                        (this.state.urlChosen == undefined) ?
                            ...
                            :
                            <TouchableOpacity style={{ width: screenWidth, height: 360 }}>
                    ...
                    }
                    {
                        this.props.post.photos?.map(e =>
                            ...
                            >
                                <Image
                                    source={{ uri: e }}
                                    style={{ width: 95, height: 90, backgroundColor: 'rgba(0,0,0,0.1)', borderRadius: 12, marginVertical: 10, marginHorizontal: 5 }} />
                            </TouchableOpacity>
                        )
                    }
                </View>
