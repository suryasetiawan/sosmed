...
import { StyleSheet, Text, View, Button, TouchableOpacity, FlatList, Dimensions, Image, SafeAreaView } from 'react-native';
    ...
    render() {
        return (
            <SafeAreaView style={{ flex: 1, backgroundColor: 'white', justifyContent: 'center', alignItems: 'center', }}>
                ...
                <View style={{ marginTop: 30, height: 50, width: screenWidth, borderBottomColor: 'rgba(0,0,0,0.1)', borderBottomWidth: 0.5, justifyContent: 'space-between', flexDirection: "row" }}>
